  ...
  Widget build(BuildContext context) {
    switch (ScreenType().getScreenType(context)) {
      case screenType.Celular:
        return _QuartaTelaQueApareceCelular();
      case screenType.Tablet:
        return _QuartaTelaQueApareceTablet();
      case screenType.Monitor:
        return _QuartaTelaQueApareceMonitor();
    }
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
            Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
              Row(children: <Widget>[
                Icon(
                  CupertinoIcons.money_dollar_circle,
